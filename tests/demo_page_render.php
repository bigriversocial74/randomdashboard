...
$allowed = [
    'dashboard.php','briefing.php','reports.php','spend-strategy.php','supplier-portal.php','accounts-payable.php','suppliers.php','sourcing.php','scenarios.php','mitigations.php','executions.php','performance.php','contracts.php','demand.php','fulfillment.php','items.php','purchase-orders.php',
    'inventory.php','inventory-operations.php','scorecards.php','imports.php','discovery.php','data-collection.php','agent.php','savings.php','savings-realization.php','approvals.php','tour.php',
