...
pages=(
  dashboard.php briefing.php reports.php suppliers.php sourcing.php scenarios.php mitigations.php executions.php items.php purchase-orders.php inventory.php
...
for report in docs/SECTION_{1..14}_QUALITY_REPORT.md docs/QUALITY_SCORECARD.md docs/SQL_CHANGE_LEDGER.md; do
  [[ -f "$report" ]] || { echo "Missing quality evidence: $report" >&2; exit 1; }
done

echo "All Sections 1-14 quality gates passed."
