...
$grantCompanies=array_map('intval',array_column(array_filter(supplier_portal_access_grants((int)$account['id']),static fn(array$g):bool=>($g['status']??'')==='active'),'company_id'));
$remittances=accounts_payable_supplier_remittances((int)$account['supplier_id'],$grantCompanies);
