...
-- savings, reporting, and AI briefing data for five Gruber businesses.
...
CREATE TABLE purchasing_categories (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE projects_workorders (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    company_id BIGINT UNSIGNED NOT NULL,
...
INSERT INTO purchasing_categories (code, name, description) VALUES
