...
-- Import-safe single installation SQL
-- Version: 3.0.0 (Phase 2 Production Data Integration & Operational Hardening)
-- Import this file into the database selected in your hosting panel or use /install.php.
-- This script does not create, drop, or switch databases.
