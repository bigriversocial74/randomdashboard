...
$headerActions='<a class="button ghost" href="'.h(app_url('purchase-orders.php')).'">Purchase Orders</a><a class="button ghost" href="'.h(app_url('demand.php')).'">Demand</a><a class="button ghost" href="'.h(app_url('inventory.php')).'">Inventory</a>';
