...
$headerActions='<a class="button ghost" href="'.h(app_url('purchase-orders.php')).'">Purchase Orders</a><a class="button ghost" href="'.h(app_url('contracts.php')).'">Contract Governance</a><a class="button ghost" href="'.h(app_url('inventory-operations.php')).'">Inventory Operations</a>';
